                ...
                while (taskIterator < numberOfTask) {
                    try {
                        ...
                        if (task[0] != "") {
                            ...
                            console.log(
                                "The index " + taskIterator + " is empty"
                            );
                        }
                    } catch {
...
async function changeTaskStatus(id, taskIndex) {
    ...
    try {
        ...
        console.log(
            "Failed to change Status of task " + textId + " in blockchain"
        );
    }
}
    ...
    if (form.style.display != "none") {
        ...
        contract.methods
            ...
            .then(
                ...
                (err) => {
                    console.log(
                        "Failed to get the number of task in blockchain " + err
                    );
                }
            );
        try {
            ...
            await contract.methods
                .addTask(name)
                .send({ from: web3.eth.defaultAccount, value: amount });
